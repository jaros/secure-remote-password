...
// bitGroup - currently is either '2048-bit' (default) or '1024-bit'
module.exports = function (bitGroup) {
  const input = bitGroup === '1024-bit' ? {
    ...input2048Bit,
    largeSafePrime: `
  ...
  console.log('input.paddedLength', input.paddedLength)
